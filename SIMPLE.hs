...
--asta nu merge pt ca au Asgn variabilele
pFact= Block [ 
       Asgn "n" (I 5),
       Asgn "fact" (Id "n"),
       Asgn "i" (I 1),
...
-- asta merge ca le-am pus Decl la variabile, adica le-am declarat
pFact2= Block [ 
       Decl "n" (I 5),
       Decl "fact" (Id "n"),
       Decl "i" (I 1),
       While (BinE Neq  (Id "n") (Id "i")) 
                (Block [ Asgn "fact" (BinA Mul (Id "fact") (Id "i")),
                       Asgn "i" (BinA Add (Id "i") (I 2))
                       ])
              ]
-- asta nu merge pt ca la ultima chestuie am pus B True si zice eroarea type mismatch ca nu poate aduna int cu bool
pFact3= Block [ 
       Decl "n" (I 5),
       Decl "fact" (Id "n"),
       Decl "i" (I 1),
